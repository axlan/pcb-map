...
MQTTClientManager mqtt_manager(
    MQTT_CLIENT_NAME,
    {MQTT_CLEAR_WIFI_TOPIC, MQTT_PING_TOPIC, MQTT_SPRITE_DELETE_TOPIC,
     MQTT_SPRITE_UPDATE_TOPIC, MQTT_SPRITES_CLEAR_TOPIC,
     MQTT_BACKGROUND_SET_ROW_TOPIC, MQTT_BACKGROUND_SHOW_TOPIC,
     MQTT_BACKGROUND_HIDE_TOPIC, MQTT_SET_BRIGHTNESS_TOPIC},
